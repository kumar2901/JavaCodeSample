...
import com.db.LibrarianupdatepasswordDao;
 ...
 */
@WebServlet("/LibrarianUpdatePassword")
public class LibrarianUpdatePassword extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public LibrarianUpdatePassword() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int status=LibrarianupdatepasswordDao.update(oldnumber,newnumber);
		if(status>0)
		{
