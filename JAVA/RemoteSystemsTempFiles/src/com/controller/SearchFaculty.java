...
public class SearchFaculty extends HttpServlet{ 
 ...
 public void doPost(HttpServletRequest request, 
  ...
  String  emp_name  = request.getParameter("fname");
  String  emp_dept  = request.getParameter("depart");

  ArrayList al=null;
  ArrayList emp_list =new ArrayList();
  String query = 
		  "select * from facultyregister where firstname='"+emp_name+"' and  department='"+emp_dept+"'";
 ...
 System.out.println("empList " + emp_list);
  ...
  String nextJSP = "/searchfaculty.jsp";
