...
import com.db.StudentForgotPasswordDao;
...
public class StudentForgotPassword extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int status=StudentForgotPasswordDao.update(password,name);
		if(status>0)
		{
			RequestDispatcher rd=request.getRequestDispatcher("studentloginmessage.html");
